<script>
  ...
  export let show,picture,item
</script>

<div class="blackScreen">
  <div class="social-media-ctn">
    <!-- cross -->
    <button class="cross" on:click={show}>
      <svg
        width="24"
        height="24"
        viewBox="0 0 24 24"
    ...
    <img src={picture} alt="cone" class="mini-img" />

    <p class="subtitle">Comparte con tus amigos!</p>
    <div class="buttons-ctn">
      <a class="whatsapp-ctn btn" target="_blank" href={"https://wa.me/?text=https://churrolocura-test.vercel.app/mobile/mobile/item?name="+item.title.replace(" ","+")} >
        <!-- icon -->
        <svg
          width="24"
          height="24"
      ...
      <a class="facebook-ctn btn" target="_blank" href={"http://www.facebook.com/sharer.php?u=https://churrolocura-test.vercel.app/mobile/mobile/item?name="+item.title.replace(" ","+")}>
        <!-- icon -->
        <svg
          width="24"
          height="24"
      ...
      <a class="twitter-ctn btn" target="_blank" href={"http://www.twitter.com/share?url=https://churrolocura-test.vercel.app/mobile/mobile/item?name="+item.title.replace(" ","+")} >
        <!-- icon -->
        <svg
          width="24"
          height="24"
